...
<head>
    ...
    <script type="text/javascript" src="./templates/jscriptv23/kb.min.js"></script>
    <script type="text/javascript" src="./templates/jscriptv23/icons.min.js"></script>
    <script type="text/javascript" src="./templates/jscriptv23/jsglobal.min.js"></script>
</head>
<body onload="init();">
    <div id="lz_kb_main">
