...
define("TEMPLATE_SCRIPT_TRACK",PATH_TEMPLATES . "jscriptv23/jstrack.tpl");
define("TEMPLATE_SCRIPT_CONNECTOR",PATH_TEMPLATES . "jscriptv23/jsconnector.tpl");
define("TEMPLATE_SCRIPT_GROUPS",PATH_TEMPLATES . "jscriptv23/jsgroups.tpl");
define("TEMPLATE_SCRIPT_GLOBAL",PATH_TEMPLATES . "jscriptv23/jsglobal.js");
define("TEMPLATE_SCRIPT_INVITATION",PATH_TEMPLATES . "invitations/");

define("TEMPLATE_SCRIPT_OVERLAY_CHAT",PATH_TEMPLATES . "overlays/chatv23/");
define("TEMPLATE_HTML_MESSAGE_OVERLAY_CHAT_STATUS",PATH_TEMPLATES . "overlays/chatv23/messagestatus.tpl");
define("TEMPLATE_HTML_MESSAGE_OVERLAY_CHAT_PICTURE",PATH_TEMPLATES . "overlays/chatv23/messagepicture.tpl");
