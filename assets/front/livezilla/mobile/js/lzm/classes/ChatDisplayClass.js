...
CommonUIClass.prototype.RenderChatInfo = function(){
    ...
    if(addNew != null)
    {
        $('#chat-info-elements').append('<div id="visitor-info-e-'+visitor.id+'-placeholder" class="embedded-visitor-info" data-visitor-id="'+visitor.id+'"></div><div id="visitor-info-offline-indicator-e" class="visitor-info-offline-indicator">'+tid('offline')+'</div>');
