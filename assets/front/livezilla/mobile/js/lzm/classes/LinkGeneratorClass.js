...
LinkGeneratorClass.DataPassThruPlaceholderURLEncodeEXT = 'base64_url_encoded_';
...
LinkGeneratorClass.prototype.GetCodeParameters = function(type,element,bind){
    ...
    if(type == 'inlay-image' || type == 'overlay-button-v1')
    {
        ...
        */
        ...
        $('#cb-m_UsePassThruStandard').change(function() {
            ...
            $('.m_UsePassThruStandard input').each(function(){
                ...
                if(that.m_Type == 'inlay-image' || that.m_Type == 'inlay-text' || that.m_Type == 'overlay-button-v1')
                    ph += LinkGeneratorClass.DataPassThruPlaceholderURLEncodeEXT;
