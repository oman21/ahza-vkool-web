        ...
        <div class="row">
            <div class="col-md-12">
                <div class="dashboard-stat2">
                    <form class="form-horizontal" role="form" action="<?=base_url()?>admin/otomotif/proses_edit" method="post" enctype="multipart/form-data">
                        <input type="hidden" value="<?=$data['otomotif']->id?>" name="id">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Nama</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="nama" id="nama" value="<?=$data['otomotif']->ind_nama?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Kode Link</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="kode_link1" placeholder="Generate Otomatis" disabled="" value="<?=$data['otomotif']->link_code?>">
                                    <input type="hidden" id="kode_link2" name="kode_link" value="<?=$data['otomotif']->link_code?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Gambar 1</label>
                                <div class="col-md-9">
                                    <img id="show_img1" src="<?=base_url()?>content/otomotif/<?=$data['otomotif']->img1?>" alt="your image" width="50%" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <img id="show_img2" src="<?=base_url()?>content/otomotif/<?=$data['otomotif']->img2?>" alt="your image" width="50%" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <img id="show_img3" src="<?=base_url()?>content/otomotif/<?=$data['otomotif']->img3?>" alt="your image" width="50%" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <img id="show_img4" src="<?=base_url()?>content/otomotif/<?=$data['otomotif']->img4?>" alt="your image" width="50%" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" id="konten_id" name="konten_id"><?=$data['otomotif']->ind_content?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Produk (EN)</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" id="konten_en" name="konten_en"><?=$data['otomotif']->en_content?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <table class="table table-bordered" id="editableTable" style="width: 600px;">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <td data-field='name'><?=$row->data?><input type="hidden" name="performa_data[]" value="<?=$row->data?>"></td>
                                                <td data-field='name'><?=$row->value?><input type="hidden" name="performa_value[]" value="<?=$row->value?>"></td>
                                                <td>
                                                    <a class='button button-small editlah' title='Save'><i class='fa fa-pencil'></i></a> 
                                                    <a class='button button-small' title='Delete'><i class='fa fa-trash'></i></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            <tr>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" id="faq_id" name="faq_id"><?=$data['otomotif']->ind_faq?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">FAQ (EN)</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" id="faq_en" name="faq_en"><?=$data['otomotif']->en_faq?></textarea>
                                </div>
                            </div>
                            <br/>
                            <h3>WARRANTY</h3>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" id="warranty_id" name="warranty_id"><?=$data['otomotif']->ind_warranty?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Warranty (EN)</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" id="warranty_en" name="warranty_en"><?=$data['otomotif']->en_warranty?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
