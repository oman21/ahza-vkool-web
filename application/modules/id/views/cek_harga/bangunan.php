...
<div  style="background: url('<?=base_url()?>assets/front/material/home2.jpg'); background-size: auto 100%">
	<section class="page-title page-title-2 image-bg overlay parallax">
	    ...
	    <div class="container">
	        <div class="row">
	            <div class="col-md-6">
	                <h2 class="uppercase mb8">Cek Harga Bangunan</h2>
	                <p class="lead mb0"></p>
	            </div>
	...
	<section class="form-vkool">
	    <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
	        <div class="feature boxed bg-secondary">
	            <form id="form_harga">
	                <h4 class="uppercase mt48 mt-xs-0">Estimasi Biaya Kaca Film untuk Bangunan</h4>
	                ...
	                <div class="overflow-hidden">
						...
						<div class="select-option">
	                    	...
	                    	<select id="harga" name="harga">
	                    		<option selected="" value="" hidden="" disabled=""> - Pilih Tipe V-Kool - </option>
	                ...
	                <div class="overflow-hidden">
	                    <h6 class="uppercase">
						 ...
						 <input type="text" name="panjang" class="col-md-12" placeholder="Ukuran Panjang" />
						 <input type="text" name="lebar" class="col-md-12" placeholder="Ukuran Lebar" />
	                </div>
	                <div class="overflow-hidden">
	                    <h6 class="uppercase">
	                    	<br/>
						 ...
						 <input type="text" name="jumlah" class="col-md-12" placeholder="Jumlah" />
	                </div>
					<div class="row">
						<div class="col-md-12">
...
<script type="text/javascript">
    $('#form_harga').validate({
        ...
        submitHandler:function(e){
            $.ajax({
                url         : '<?=base_url()?>id/cek_harga/hitung_bangunan',
