    ...
    <div class="container">
        <div class="row mb64 mb-xs-24">
            <div class="col-md-10 col-md-offset-1 col-sm-12 text-center">
                <h3>Please Choose Near V-Kool Dealer</h3>
            </div>                        
        </div>
        <div class="row">
        	<div class="col-md-6">
				<div class="select-option">
		        	...
		        	<select name="provinsi" id="provinsi">
		            	<option selected value="" selected="" disabled="" hidden=""> - Province - </option>
	    	...
	    	<div class="col-md-6">
				<div class="select-option">
		        	...
		        	<select name="kota" id="kota" onchange="filterDealer()">
		            	<option selected value="" selected="" disabled="" hidden=""> - City - </option>
...
<script type="text/javascript">
    ...
    function loadDealer(kota){
    	...
    	$.ajax({
			url: "<?=base_url()?>en/dealer/listDealer/"+kota,
			type: "GET",
			dataType: "JSON",
