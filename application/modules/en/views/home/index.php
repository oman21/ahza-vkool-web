                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <p class="lead mb48 mb-xs-32 col-md-6 <?=$row->text_color_konten?>">
                                <?=$row->en_konten?>
                                <?=$row->en_tombol!=''?'<a class="btn btn-lg '.$row->text_color_tombol.' mb0" href="#">'.$row->en_tombol.'</a>':''?>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-bottom">
        <div class="row">
            <div class="col-md-12 text-center">
                <a class="js-open-modal" href="#" data-modal-id="popup1"><h2><?=$video->en_judul?></h2></a>
                <p class="lead mb48 mb-xs-32" >
                    <a href="<?=base_url()?>video" class="video-lainnya"><?=$video->en_subjudul?> <i class="fa fa-video-camera"></i></a>
                </p>
            </div>
        </div>
        <!--end of row-->
    ...
    <div class="<?=$row->v_align?>">
        <div class="row">
            <div class="col-md-12 <?=$row->h_align?>">
                <h2 class="<?=$row->text_color_judul?>"><?=$row->en_judul?></h2>
                <p class="lead mb48 mb-xs-32">
                    <a class="btn btn-lg mb0 <?=$row->text_color_tombol?>" href="#"><?=$row->en_tombol?></a>
                </p>
            </div>
        </div>
        <!--end of row-->
