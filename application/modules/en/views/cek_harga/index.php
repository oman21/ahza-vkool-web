	...
	<section class="form-vkool">
	    <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
	        <div class="feature boxed bg-secondary">
	            <form id="form_harga">
	                <h4 class="uppercase mt48 mt-xs-0">ESTIMATION OF GLASS FILM COSTS FOR VEHICLES</h4>
	                ...
	                <div class="overflow-hidden">
						...
						<div class="select-option">
	                    	...
	                    	<select id="mobil_merk" name="mobil_merk">
	                    		<option selected="" value="" hidden="" disabled=""> - Select Vehicle Brand - </option>
						...
						<div class="select-option">
	                    	...
	                    	<select id="mobil_tipe" name="mobil_tipe">
	                        	<option selected="" value="" hidden="" disabled=""> - Select Vehicle Type - </option>
	                ...
	                <div class="overflow-hidden">
						...
						<div class="select-option">
	                    	...
	                    	<select id="bagian_depan" name="bagian_depan">
	                        	<option selected value="" selected="" disabled="" hidden=""> - Front - </option>
						...
						<div class="select-option">
	                    	...
	                    	<select id="bagian_samping" name="bagian_samping">
	                        	<option selected value="" selected="" disabled="" hidden=""> - Side - </option>
						...
						<div class="select-option">
	                    	...
	                    	<select id="bagian_belakang" name="bagian_belakang">
	                        	<option selected value="" selected="" disabled="" hidden=""> - Back - </option>
...
<script type="text/javascript">
    ...
    $('#form_harga').validate({
        ...
        submitHandler:function(e){
            $.ajax({
                url         : '<?=base_url()?>en/cek_harga/hitung',
